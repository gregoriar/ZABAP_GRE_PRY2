  ...
  " Load initial data for persistence principal DB  Incident
    MODIFY zdt_inct_user073 FROM TABLE @( VALUE #(
                                                   ...
                                                   ( inc_uuid         = 3
                                                     ...
                                                     local_created_by   = 'CB9980000073'  )


                                                   ( inc_uuid         = 4
                                                     incident_id      = 4
                                                     title            = 'Ajuste de visagr IV' "Revisar y no agrandar tamaño del char
                                                     description      = 'Fallas en visagra IV Reaparación engranaje III' "Revisar y  no agrandar tamaño del char
                                                     status           = 'OP'
                                                     priority         =  'L'
                                                     creation_date    = '20250901'
                                                     local_created_by = 'CB9980000073'
